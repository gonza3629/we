...
<title>Menú de 6 apartados</title>
<style>
  body {
    font-family: Arial, sans-serif;
    margin: 0;
    padding: 0;
    background-color: #f9ead9; /* Fondo crema */
    background-image: url('https://images.unsplash.com/photo-1519069032624-4c647ffdb23e'); /* Imagen de fondo con nubes */
  ...
  #menu {
    position: fixed;
    top: 5%; /* Ajustar la posición del menú */
    left: 50%;
    transform: translateX(-50%);
    background-color: #ffb6c1; /* Menú rosa viejo */
    padding: 2% 5%; /* Ajustar el padding para hacer el menú más ancho */
  ...
  #menu ul li {
    margin-bottom: 2%; /* Aumentar el espacio entre elementos del menú */
  }
  #menu ul li a {
    color: #000; /* Texto del menú negro */
    text-decoration: none;
    font-size: 2vw; /* Ajustar el tamaño del texto del menú */
    display: block;
    padding: 2% 5%; /* Ajustar el padding para hacer el texto más ancho */
    border-radius: 15px; /* Ajustar el radio del borde para hacerlo más redondeado */
    background-color: #fff; /* Fondo blanco */
    border: 4px solid #ffb6c1; /* Aumentar el ancho del borde del contorno */
  }
  .seccion {
    display: none; /* Oculta todas las secciones al principio */
    padding: 2%;
    background-color: rgba(255, 255, 255, 0.8); /* Fondo blanco con transparencia */
    border-radius: 10px;
    border: 2px solid #ffb6c1; /* Agrega un contorno a las secciones */
  }
</style>
</head>
<body>
